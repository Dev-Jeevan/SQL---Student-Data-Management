--Q 1.	Create a database called “LMT_University”.
create database LMT_University;
use LMT_University;
--Q 2.	Create an “enrol” schema under “LMT_University”.
create schema enrol;
--Q 3.	Use “enrol” Schema for creating the project.
--Q 4.	Create the Database modeling in such a way that Model looks like-
--Q 5 a,b.	Create an “Address” table under “enrol” schema with the following specifications-
...
--Q 5  c.	Insert the following records based on the following specifications.
--	   d.	After Insertion, Table looks like as shown below-

insert into [enrol].[Address](StreetAddress, City, State, PostalCode, Country) 
values ('5 Schurz Lane', 'Grybów',NULL,'33-330','Poland'),
...
--Q 6.	Create a “Department” table under “enrol” schema with the following specifications-
...
---Q 6 c.	Insert the following records based on the following specifications.
--    d.	After Insertion, Table looks like as shown below-
...
--- Q 7.	Create a “Lecturer” table under “enrol” schema with the following specifications-
...
-- Q 8.	Create a “Student” table under “enrol” schema with the following specifications-
